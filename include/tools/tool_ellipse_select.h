#ifndef TOOL_ELLIPSE_SELECT_H
#define TOOL_ELLIPSE_SELECT_H
...
/**
 * Elliptical Selection Tool state and options
 */
typedef struct {
    gboolean is_dragging;               /* Currently dragging a selection ellipse? */
    ...
    gint selection_x;                   /* Selection bounding rectangle position X */
    gint selection_y;                   /* Selection bounding rectangle position Y */
    gint selection_w;                   /* Selection bounding rectangle width */
    gint selection_h;                   /* Selection bounding rectangle height */
...
/**
 * Draw elliptical selection preview during editing/dragging
...
/**
 * Animation timer callback for elliptical selection tool preview
